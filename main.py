...
def main():
    ...
    game_over = False
    paused = False  # Nueva variable de pausa
    ...
    while True:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_p and not game_over:  # Solo pausar si no hay game over
                    paused = not paused
                elif event.key == pygame.K_r and game_over:
                    snake.reset()
                    food.randomize()
                    game_over = False
                elif not game_over and not paused:  # Solo procesar movimientos si no está pausado
